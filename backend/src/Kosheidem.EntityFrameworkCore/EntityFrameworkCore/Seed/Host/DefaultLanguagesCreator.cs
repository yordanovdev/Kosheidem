...
namespace Kosheidem.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly KosheidemDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = KosheidemConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(KosheidemDbContext context)
        {
            _context = context;
        }
