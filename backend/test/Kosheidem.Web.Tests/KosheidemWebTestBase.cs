...
{
    public abstract class KosheidemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static KosheidemWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(KosheidemWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<KosheidemDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<KosheidemDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<KosheidemDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<KosheidemDbContext, Task<T>> func)
        {
            T result;
